...
const speakers: Speaker[] = [
  ...
  },
  {
    ...
    iconHeight: 80,
    iconWidth: 80,
    description: 'Anup Jagwani is the World Bank Group\'s Director for Farming and Agribusiness. He brings over 25 years of World Bank Group experience across investment operations, climate finance, and agribusiness. Most recently, Anup served as IFC\'s Senior Manager, Farming and Agribusiness, Solutions & Impact. In his current role, he leads the WBG\'s efforts to transform food systems, scale climate smart agriculture, and advance the AgriConnect agenda.'
  },
  {
    name: 'Teddy Esteve',
