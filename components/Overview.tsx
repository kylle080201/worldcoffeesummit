            ...
            >
                ...
                <div className="absolute top-6 right-6 z-10">
                    <Link href={"https://worldcoffeealliance.com/"} target='_blank'>
                        <img src="https://worldcoffeealliance.com/wp-content/uploads/2021/08/WCA_new_logo.png" alt="Icon" className="w-24 h-24 md:w-32 md:h-32 xlw-44 xl:h-44" />
                    </Link>
                </div>

                {/* Main Container */}
                <div className="relative flex flex-col items-center text-center text-white mt-32 md:mt-2 xl:mt-0">
                    {/* Event Title */}
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mt-[4rem] md:mt-[5rem] xl:mt-[25rem]">
                        <Link href="/interest">
                            <button className="bg-orange-400 text-yellow-900 hover:bg-orange-500 hover:drop-shadow-xl font-bold text-lg md:text-xl xl:text-5xl py-1 md:py-2 xl:py-3 px-6 rounded-md">
                    ...
                    <div className="mt-6 flex flex-col sm:flex-row items-center bg-yellow-200/40 p-2 md:p-4w xl:p-6 rounded-md shadow-md gap-4">
