        ...
        {/* V1 */}
            ...
            >
                ...
                <div className="relative flex flex-col items-center text-center text-white mt-32 md:mt-12 xl:mt-0">
                    ...
                    {/* Event Title */}
                    <h1 className="text-[3rem] sm:text-[4rem] md:text-[6rem] font-bold tracking-tight drop-shadow-xl">
                        THE BIGGER PICTURE
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mt-[34rem]">
                        <Link href="/interest">
                            <button className="text-white hover:underline hover:drop-shadow-xl font-bold text-3xl sm:text-5xl md:text-6xl py-3 px-6 rounded-md">
                    ...
                    <div className="mt-6 flex flex-col sm:flex-row items-center bg-yellow-200/40 p-4 sm:p-6 rounded-md shadow-md gap-4">
                        <div className="p-2 bg-lime-700 rounded-md w-fit text-xl sm:text-2xl md:text-3xl font-bold tracking-wide">
                            22-23 October 2025 <span className="block sm:inline">| London</span>
                        </div>
                        <img className="w-[18rem] sm:w-[20rem]" src="https://worldcoffeealliance.com/wp-content/uploads/2023/06/QEII-CENTRE.png" alt="QEII Centre" />
                        <img className="w-[10rem] sm:w-[12rem]" src="https://worldcoffeealliance.com/wp-content/uploads/2024/05/House_of_Lords_logo_2020.svg.png" alt="House of Lords" />
                    </div>
