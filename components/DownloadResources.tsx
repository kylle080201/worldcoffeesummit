      ...
      <div>
        ...
        <div className='px-12 sm:px-2 max-w-7xl md:px-0 mx-auto bg-gray-100 rounded-md shadow-md'>
          <div className='mx-auto sm:content-center px-12 py-8'>
            ...
            <Link href={'/resources/form'} className="flex max-w-[10rem] mt-4 justify-center px-3 py-2 text-sm font-semibold text-white border border-transparent rounded-md shadow-sm bg-lime-700 hover:cursor-pointer hover:bg-lime-900 focus:outline-none">
              Download
            </Link>
          </div>
        </div>
