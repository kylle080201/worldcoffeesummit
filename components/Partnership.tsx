    ...
    return (
        <>
            <div className="flex px-4 sm:px-8 items-center justify-center flex-row bg-[url('https://worldcoffeealliance.com/wp-content/uploads/2023/01/PARTNERSHIP-2.jpg')] mlg:flex-col bg-cover  h-96 w-full ">
                <div>
                    <h1 className='text-5xl font-bold text-white shadow-md sm:text-8xl'>PARTNER WITH US</h1>
                </div>
            </div>
            <div className="px-4 py-32 sm:px-8 lg:px-80 bg-lime-700">
                <div>
                    <h3 className='text-2xl font-semibold text-white sm:text-5xl'>OUR PARTNERSHIP AND MARKETING OPPORTUNITIES ARE DESIGNED TO MAXIMIZE YOUR BRAND&apos;S PRESENCE AT WCA WORLD COFFEE SUMMIT LONDON 2023.</h3>
                </div>
