...
export default function Footer() {
    ...
    return (
        <>
            <footer>
                <div className="w-full py-4 text-center bg-gray-200" >
                    ©2026
