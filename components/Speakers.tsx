...
const speakers = [
    ...
    },
    {
        ...
        company: 'Meridia',
        imageUrl:
            'https://worldcoffeealliance.com/wp-content/uploads/2023/09/Thomas-Vaassen-Meridia-scaled.jpg',
    },
]
...
export default function Speakers() {
    ...
    const [openSpeaker30, setOpenSpeaker30] = useState(false)
    ...
    return (
        <>
            <div className="px-12 py-20 bg-gray-100 sm:px-20" id='speakers'>
                <div className="mx-auto sm:content-center">
                    <div className="max-w-2xl mx-auto text-center">
                        <p className="text-lg font-bold tracking-tight text-gray-900 sm:text-2xl">World Coffee Summit 2023 Speakers</p>
                    </div>
                    <ul
                        role="list"
                    ...
                    >
                        ...
                        {/* speaker 23 */}
                        <li>
                            <a onClick={() => { setOpenSpeaker23(!openSpeaker23) }} className="flex flex-col gap-6 hover:cursor-pointer">
                                <div className='flex-shrink-0 mx-auto'>
                                    <Image className="rounded-md w-[30rem] " src={speakers[23].imageUrl} alt={speakers[23].name} width={160} height={160} />
                                </div>
                                <div className="flex mx-auto text-center">
                                    <div>
                        ...
                        {/* speaker 30 */}
                        <li>
                            <a onClick={() => { setOpenSpeaker30(!openSpeaker30) }} className="flex flex-col gap-6 hover:cursor-pointer">
                                <div className='flex-shrink-0 mx-auto'>
                                    <Image className="rounded-md w-[30rem] " src={speakers[30].imageUrl} alt={speakers[30].name} width={160} height={160} />
                                </div>
                                <div className="flex mx-auto text-center">
                                    <div>
                                        <p className="text-lg font-semibold leading-8 tracking-tight text-gray-900 md:text-2xl">{speakers[30].name}</p>
                                        <p className="leading-7 text-gray-700 text-md">{speakers[30].role}</p>
                                        <p className="font-semibold leading-7 text-gray-900 text-md">{speakers[30].company}</p>
                                    </div>
                                </div>
                            </a>
                        </li>
                        ...
                        <div className="flex justify-center min-h-full p-4 text-center sm:items-center sm:p-0">
                            ...
                            >
                                <Dialog.Panel className="relative px-4 pt-5 pb-4 text-left transition-all transform bg-white rounded-lg shadow-xl h-max sm:my-8 sm:w-full sm:max-w-4xl sm:p-6">
                                    <div className='flex flex-col h-max'>
                                        <div className='flex-shrink-0 mx-auto'>
                                            <Image className="rounded-md w-[20rem] " src={speakers[23].imageUrl} alt={speakers[23].name} width={160} height={160} />
                                        </div>
                                        <div className="flex mx-auto text-center">
                                            <div>
                                                <p className="text-lg font-semibold leading-8 tracking-tight text-gray-900 md:text-2xl">{speakers[23].name}</p>
                                    ...
                                    <div className="mt-5 sm:mt-6">
                                        <button
                                            type="button"
                                            className="inline-flex justify-center max-w-5xl px-3 py-2 text-sm font-semibold text-white rounded-md shadow-sm bg-lime-700 hover:bg-lime-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-lime-700"
                                            onClick={() => setOpenSpeaker23(!openSpeaker23)}
                                        >
                                            Back
                                        </button>
                                    </div>
            ...
            {/* speaker 30 */}
            <Transition.Root show={openSpeaker30} as={Fragment}>
                <Dialog as="div" className="relative z-10" onClose={setOpenSpeaker30}>
                    <Transition.Child
                        as={Fragment}
                        enter="ease-out duration-300"
                        enterFrom="opacity-0"
                        ...
                        <div className="flex justify-center min-h-full p-4 text-center sm:items-center sm:p-0">
                            ...
                            >
                                <Dialog.Panel className="relative px-4 pt-5 pb-4 text-left transition-all transform bg-white rounded-lg shadow-xl h-max sm:my-8 sm:w-full sm:max-w-4xl sm:p-6">
                                    <div className='flex flex-col h-max'>
                                        <div className='flex-shrink-0 mx-auto'>
                                            <Image className="rounded-md w-[20rem] " src={speakers[30].imageUrl} alt={speakers[30].name} width={160} height={160} />
                                        </div>
                                        <div className="flex mx-auto text-center">
                                            <div>
                                                <p className="text-lg font-semibold leading-8 tracking-tight text-gray-900 md:text-2xl">{speakers[30].name}</p>
                                    ...
                                    <div className="overflow-auto text-sm sm:text-md sm:mt-5 max-h-60">
                                        <p className="mt-2 text-gray-600">
                                        Thomas is the co-founder and CEO of Meridia, an agricultural technology company specializing in the verification of farm origin and supply chain data. Building Meridia from the ground up, Thomas has engaged with thousands of smallholder farmers in Africa and Asia, putting them on the map, quite literally, through Meridia&apos;s large-scale farm mapping as well as land titling and even shade tree registration. By working with all actors in the supply chain--from farmer cooperatives, to national governments and large multinational companies--Thomas has developed solutions that work on the ground but also scale across origins and commodities. Thomas has been a serial entrepreneur since graduating as a MSc in Business Administration almost two decades ago.
                                        </p>
                                    </div>
                                    <div className="mt-5 sm:mt-6">
                                        <button
                                            type="button"
                                            className="inline-flex justify-center max-w-5xl px-3 py-2 text-sm font-semibold text-white rounded-md shadow-sm bg-lime-700 hover:bg-lime-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-lime-700"
                                            onClick={() => setOpenSpeaker30(!openSpeaker30)}
                                        >
                                            Back
                                        </button>
                                    </div>
