...
function Agenda() {
  return (
    <>
          <div id="agenda" className='py-20 max-w-5xl mx-auto px-2 md:px-0'>
              ...
              <div className='mt-8'>
                  ...
                  <div className='mt-4 px-2 max-w-3xl'>
                      <ul className="list-disc pl-6">
                          <li>Impacts of Blended Investing: Accessing global coffee finance in a changing power asymmetry.</li>
                          <li>Does linking ethical investing with the certification of coffee enhance credit outcomes for small farmers?</li>
                          <li>The question of scalability and affordability of financing platforms. Unlocking the Impact investing potential.</li>
                          <li>How do we finance the transition from conventional to regenerative? </li>
                      </ul>
                      <div className='mt-2'>
                          <h3>Moderator:</h3>
