            ...
            <div className='py-20 max-w-5xl mx-auto'>
                ...
                <div className='mt-8'>
                    ...
                    <div className='mt-4 px-2 max-w-5xl'>
                        <h3 className=''>
                            <span className='font-bold'>Joy Macknight</span>, <span className='italic'>Journalist, Former Editor</span>, <span className='font-bold'>Financial Times - The Banker</span>
                        </h3>
                    </div>
                </div>
                ...
                <div className='mt-8'>
                    ...
                    <div className='mt-4 px-2 max-w-5xl'>
                        <h3 className=''>
                            <span className='font-bold'>Dr. Alvaro Lario</span>, <span className='italic'>President,</span> <span className='font-bold'>International Fund of Agricultural Development (IFAD)</span>
                        </h3>
                    </div>
                </div>
                ...
                <div className='mt-8'>
                    ...
                    <div className='mt-2'>
                        <h3>Speaker:</h3>
                        <h3 className=''>
                            <span className='font-bold'>The Rt. Hon John Gummer, Lord Deben</span>, <span className='italic'>Former Chairman</span>, <span className='font-bold'>UK Climate Change Committee (The CCC)</span>
                        </h3>
                    </div>
                </div>
                ...
                <div className='mt-8'>
                    ...
                    <div className='mt-4 px-2 max-w-3xl'>
                        <h3 className=''>
                            <span className='font-bold'>Clive de Ruig</span>, <span className='italic'>President,</span> <span className='font-bold'>ICE Benchmark Administration (IBA)</span>
                        </h3>
                    </div>
                </div>
                    ...
                    <div className='mt-4 px-2 max-w-3xl'>
                        <ul className='mt-2 list-disc'>
                            <div className='pl-6'>
                                ...
                                <li>What are the main environmental risk areas within the coffee supply chain – and how are these being addressed? What are the trickiest challenges?</li>
                    ...
                    <div className='mt-4 px-2 max-w-3xl'>
                        <ul className='mt-2 list-disc'>
                            <div className='pl-6'>
                                ...
                                <li>How do you think the Corporate Sustainability Reporting Directive (CSRD) and Corporate Sustainability Due Diligence Directive (CS3D) will drive meaningful change in corporate climate action strategies? What do we need to ensure to fully recognize this?</li>
                                <li>What is the importance of data ownership, its social impact, risk sharing on the farmers and the need to distribute the value much more fairly in the coffee industry?</li>
                            </div>
                        </ul>
                        <div className='mt-2'>
                            <h3>Chair:</h3>
                    ...
                    <div className='mt-4 px-2 max-w-3xl'>
                        <ul className='mt-2 list-disc'>
                            <div className='pl-6'>
                                ...
                                <li>Improving soil health is a key part of regenerative agriculture. How does innovation and data-driven agriculture drive climate change adaptation and support sustainable food systems?</li>
                                ...
                                <li>What collaborations are we seeing between farmers and suppliers to promote and facilitate the transition toward sustainable, regenerative, and nature-positive practices? How can these initiatives be effectively implemented to strengthen resilience across supply chains?</li>
                                <li>Large landowners and institutional investors play a crucial role in catalyzing the transition to sustainable agriculture. What strategies are institutional investors employing to demonstrate the value of regenerative agriculture to landowners, and how are they supporting this transition?</li>
                            </div>
                        </ul>
                        <div className='mt-2'>
                            <h3>Chair:</h3>
                        ...
                        <ul className='mt-2 list-disc'>
                            <div className='pl-6'>
                                <li className=''><span className='font-bold'>Ritesh Sharan</span>, <span className='italic'>Director, Global Farmer Support Centers & Hacienda Alsacia</span>, <span className='font-bold'>Starbucks</span></li>
                                <li className=''><span className='font-bold'>Jonathan Sullivan</span>, <span className='italic'>Vice President Commercial & Sustainability</span>, <span className='font-bold'>Agmatix</span></li>
                                <li className=''><span className='font-bold'>Franco Costantini</span>, <span className='italic'>CEO</span>, <span className='font-bold'>Regenagri</span></li>
                                <li className=''><span className='font-bold'>Dominic Robinson</span>, <span className='italic'>CEO</span>, <span className='font-bold'>Soil Association Certification</span></li>
                            </div>
                        </ul>
                    </div>
                </div>
                ...
                <div className='mt-8'>
                    ...
                    <div className='mt-4 px-2 max-w-3xl'>
                        <h3 className=''>
                            <span className='font-bold'>Dr. Ngozi Okonjo-Iweala</span>, <span className='italic'>Director-General,</span> <span className='font-bold'>World Trade Organization (WTO)</span>
                        </h3>
                    </div>
                </div>
                ...
                <div className='mt-8'>
                    ...
                    <div className='mt-4 px-2 max-w-3xl'>
                        <ul className='mt-2 list-disc'>
                            <div className='pl-6'>
                                <li>An organisation is only as good as the leader that shapes their future through richness of ideas, novelty of approaches and cross-sharing of perspectives. To what extent does government or business translate these ideas into impactful actions to benefit the organisation they serve?</li>
                ...
                <div className='mt-8'>
                    ...
                    <div className='mt-4 px-2 max-w-3xl'>
                        <ul className='mt-2 list-disc'>
                            <div className='pl-6'>
                                <li>What are some major breakthroughs in the traceability space to foster ethical sourcing in coffee?</li>
                ...
                <div className='mt-8'>
                    ...
                    <div className='mt-4 px-2 max-w-3xl'>
                        <h3 className=''>
                            ...
                            <span className='italic'> Integrated Accelerator Team Leader, Special Advisor</span>,
                ...
                <div className='mt-8'>
                    ...
                    <div className='mt-4 px-2 max-w-3xl'>
                        <h3 className=''>
                            <span className='font-bold'>Patrick Lanz</span>,
                ...
                <div className='mt-8'>
                    ...
                    <div className='mt-4 px-2 max-w-3xl'>
                        <ul className='mt-2 list-disc'>
                            <div className='pl-6'>
                                <li>What is the role or impact of green finance in removing barriers that exclude people, especially smallholder farmers, as they grapple with the high cost of living and production costs?</li>
                                <li>What is the role of data in a Fintech ecosystem to improve risk management and long-term financial performance?</li>
                                <li>How can “Blended Finance” crowd in both private and public financing to create the right balance of risk allocation?</li>
                        ...
                        <div className='mt-2'>
                            <h3>Chair:</h3>
                            <h3 className=''>
                                <span className='font-bold'>Barney Reynolds</span>,
                                <span className='italic'> Partner</span>,
                                <span className='font-bold'> A&O Shearman</span>
                            </h3>
                        </div>
                        <ul className='mt-2 list-disc'>
                            <h3>Speakers:</h3>
                ...
                <div className='mt-8'>
                    ...
                    <div className='mt-4 px-2 max-w-3xl'>
                        <h3 className=''><span className='font-bold'>Sylvia J. Megret</span>, <span className='italic'>President and Chief Executive Officer</span>, <span className='font-bold'>ACDI/VOCA</span></h3>
                    </div>
                </div>
                ...
                <div className='mt-8'>
                    ...
                    <div className='mt-4 px-2 max-w-3xl'>
                        ...
                        <ul className='mt-2 list-disc'>
                            <div className='pl-6'>
                                <li className=''><span className='font-bold'>Karla Canavan</span>, <span className='italic'>Vice President, Commodity Trade and Finance, Markets</span>, <span className='font-bold'>World Wildlife Fund (WWF)</span></li>
