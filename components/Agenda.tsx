    ...
    return (
        <div id="agenda" className='w-full'>
            <div className='py-20 max-w-5xl mx-auto'>
              <h2 className="relative text-4xl font-bold text-center tracking-tight">AGENDA<span className="font-normal  -top-1 text-4xl text-red-600">*</span></h2>
                ...
                <div className='mt-8'>
                    <div className='w-full grid grid-cols-10 gap-x-4 h-max'>
                        ...
                        <div className='w-full text-white font-medium col-span-8 bg-lime-700 mx-auto flex items-center px-6 py-2'>
                             COFFEE CUPPING SESSION + NETWORKING COFFEE BREAK
                        </div>
                    </div>
                </div>    
