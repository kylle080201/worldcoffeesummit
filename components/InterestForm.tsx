...
const InterestForm = () => {
    ...
    const sectors = [
      ...
      "Commercial / Legal / Advisory / Professional Services",
      "Data / Analytics",
      "Education / Research / Training",
      "Energy",
      "Engineering",
      "Environmental Services Provider / Supplier",
      "Finance / Insurance",
      "FMCG / Retail",
      "Food / Agriculture",
      ...
      "Infrastructure",
      "IT / Software / Telecomms",
      "Materials",
      "Natural Resource Management",
      "Packaging / Print / Paper Manufacturer",
    ...
    const onSubmit = async (data: any) => {
      try {
        ...
        // Guernsey on +44, US / Canada on +1). Convert it back to the dial
        // code before sending downstream so mailers and storage keep their
        // existing shape.
        const dialCode =
          countryCodes.find((c) => c.code === data.countryCode)?.dial_code ??
          data.countryCode
        const submitData = { ...data, countryCode: dialCode }
        await fetch('/api/registrant', {
            method: 'POST',
            headers: {
                ...
                <div className="max-w-screen-md px-4 mx-auto mb-12">
                    ...
                    <form className="space-y-8" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div>
                            ...
                            <select {...register('sector')} onChange={(e) => setSelectedSector(e.target.value)} className="block w-full p-3 text-sm text-gray-900 border border-gray-300 rounded-lg shadow-sm bg-gray-50 focus:ring-primary-500 focus:border-primary-500" required>
                          ...
                          <fieldset className="mt-4">
                            <div className="space-y-4">
                              {notificationMethods.map((notificationMethod) => (
                                <div key={notificationMethod} className="flex items-center">
                                  <input
