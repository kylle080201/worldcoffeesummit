                ...
                <div className="w-5/6 py-4 mx-auto">
                    <div className="h-full p-8 bg-local bg-white bg-opacity-75 bg-cover border-none rounded-lg shadow-md mmd:text-center">
                        <div className='mx-auto my-6 w-72 justify-self-center'>
                            <img src='https://worldcoffeealliance.com/wp-content/uploads/2021/02/PDG-Wide-400-Blue.png'></img>
                        </div>
                        <h4 className="text-center text-gray-900 sm:text-sm lg:text-xl">
                            "<span className='font-bold'>Perfect Daily Grind</span> is the world's leading voice for coffee. The publication is a must-read resource for anyone with an interest in the broader
                            ...
                            content driven by insight from those who have direct experience at every stage of the supply chain."
